...
unsigned int loadTexture(const char* image, unsigned int rgb);
...
int main() {
    ...
    texture1 = loadTexture("images/container.jpg", GL_RGB);
    texture2 = loadTexture("images/awesomeface.png", GL_RGBA);
